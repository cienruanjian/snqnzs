                	...
                	<div class="col-lg-12">
                 	<section class="panel">
                      ...
                      <div class="panel-body">
                          <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Service/addHandle');?>" method="post">
                              
                              <div class="form-group">
                                  <label for="inputEmail3" class="col-sm-2 control-label"><span class="red">* </span>名称</label>
                                  <div class="col-sm-8">
                                      <input type="text" name="name" placeholder="服务联盟名称" class="form-control" id="inputEmail3">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <textarea name="intro" class="form-control" placeholder="简介"></textarea>
                                  </div>
                              </div> 
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="phone" id="inputEmail5" placeholder="联系电话">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="email" class="form-control" name="email" placeholder="邮箱" id="inputEmail5">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="addr" id="inputEmail5" placeholder="地址">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input type="text" class="form-control" name="weixin" id="inputEmail5" placeholder="微信账号">
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-2">
                                  	<img id="no-image" height="200" width="200" src="/Public/Default/images/no_image.jpg" >
                                  </div>
...
<script>
  ...
  uploadImage(url, 201, sid, "service/");
