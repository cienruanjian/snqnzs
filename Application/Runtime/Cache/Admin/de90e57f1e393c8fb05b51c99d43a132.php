                        ...
                        <div class="col-xs-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <?php echo ($titleL1); ?> &nbsp;
                                    <a href="<?php echo U('Service/add');?>" class="btn btn-xs btn-success">添加</a>
                                </header>
                                        ...
                                        <table id="table" class="table table-striped responsive" data-sortable="" data-sortable-initialized="true">
                                            ...
                                            <tbody>
                                            	<?php if(is_array($lists)): foreach($lists as $key=>$v): ?><tr>
                                                        ...
                                                        <td><?php if($v['thumb']): ?><img style="width:60px;" src="/<?php echo ($v["thumb"]); ?>" alt=""><?php else: ?>无<?php endif; ?></td>
	                                                    <td>

	                                                    	<a href="<?php echo U('Service/edit', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑"><span class="fa fa-edit text-success"></span></a>&nbsp;
                                               				
                                               				<a href="<?php echo U('Service/photo', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="图片"><span class="fa fa-photo text-success"></span></a>&nbsp;

                                             			  	<a class="del" href="<?php echo U('Service/del', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><span class="fa fa-trash-o text-success"></span></a>
