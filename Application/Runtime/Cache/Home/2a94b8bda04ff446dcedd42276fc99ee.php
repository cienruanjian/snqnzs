  ...
  <div id="Middle">
    <div id="Middle_left">
      ...
      <div id="mgnt295">
        <div id="slider">
          <ul class="pics">
            <?php if(is_array($ad)): foreach($ad as $key=>$v): ?><li><a <?php if($v['url']): ?>target="_blank" href="<?php echo ($v["url"]); ?>"<?php endif; ?>><img src="/<?php echo ($v["thumb"]); ?>" /></a></li><?php endforeach; endif; ?>
           
          </ul>
          <ul id="nav">
            <?php if(is_array($ad)): foreach($ad as $key=>$v): ?><li onmouseover="setTimeout(function(){lanrenzhijia.slider.pos(0)},300)"><?php echo ($key+1); ?></li><?php endforeach; endif; ?>
    ...
    <div id="Middle_right">
      <div id="right_Title">
        <p>
          <img src="/Public/Home/images/4.jpg" width="130" height="50" />
        </p>
    ...
    <div id="ol100">
      <div class="Middle_lm">
        ...
        <div class="Middle_Tie1">
          <div id="lma">
            <div class="h20"></div>
            <?php if(is_array($circles)): foreach($circles as $key=>$v): ?><p><a href="<?php echo U('Circle/detail', ['id' => $v['id']]);?>"><?php echo (mb_substr($v["title"], 0, 16, 'utf-8')); ?></a></p><?php endforeach; endif; ?> 
          </div>
        </div>
      </div>
...
地址：贵州省铜仁市思南县府后街县委机关大院团县委办公室   电话：0856-7222312  技术支持：慈恩软件
  ...
  <!--低陪  结束-->
  <script src="/Public/Home/js/min.js"></script>
